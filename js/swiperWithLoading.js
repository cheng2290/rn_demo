    ...
    return (<View style={styles.slide}>
        <Image resizeMode={'cover'} onLoad={props.loadHandle.bind(null, props.i)} style={styles.image} source={{uri: props.uri}} />
        {
            !props.loaded && <View style={styles.loadingView}>
                <Image style={styles.loadingImage} resizeMode="cover" source={loading} />
            </View>
        }
    </View>)
}

export default class SwiperWithLoading extends Component {
    constructor (props) {
        super(props)
        this.state = {
            imgList: [
    ...
    render () {
        return (
            <View>
                <Swiper loadMinimal loadMinimalSize={1} style={styles.wrapper} height={200} loop={false}>
                    {
